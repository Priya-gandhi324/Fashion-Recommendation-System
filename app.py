...
if upload_file is not None:
    ...
    with col1:
        st.image(filenames[int(indices[0][1])])
    with col2:
        st.image(filenames[int(indices[0][2])])
    with col3:
        st.image(filenames[int(indices[0][3])])
    with col4:
        st.image(filenames[int(indices[0][4])])
    with col5:
        st.image(filenames[int(indices[0][5])])